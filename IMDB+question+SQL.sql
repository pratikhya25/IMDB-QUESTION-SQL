...
SELECT COUNT() as Total_Rows FROM director_mapping; SELECT COUNT() as Total_Rows FROM genre;
SELECT COUNT() as Total_Rows FROM movie; SELECT COUNT() as Total_Rows FROM names;
SELECT COUNT() as Total_Rows FROM ratings; SELECT COUNT() as Total_Rows FROM role_mapping;
